...
class Viewer3D {
    ...
    loadModel(modelUrl) {
        ...
        // Kita gunakan CDN dari jsdelivr agar Anda tidak perlu repot mendownload file decoder-nya ke GitHub Anda.
        ...
        loader.load(
            ...
            (gltf) => {
                ...
                // ==========================================
                // 2. AUTO-CENTER & MENAPAK LANTAI (REFERENSI ANDA)
                // ==========================================
